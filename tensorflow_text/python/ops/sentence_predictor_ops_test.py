...
from tensorflow_text.python.ops import sentence_predictor_ops


@test_util.run_all_in_graph_and_eager_modes
class NextSentencePredictorTest(parameterized.TestCase, test.TestCase):
  ...
  def testNextSentencePredictor(self,
                                sentences,
                                expected_segment_a,
                                expected_segment_b,
                                expected_labels,
    ...
    nsp = sentence_predictor_ops.NextSentencePredictor(
